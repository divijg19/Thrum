...
use crate::ui::{
    ...
    FILES_DEVICE_WIDTH, FILES_FS_WIDTH, FILES_KIND_WIDTH, FILES_SIZE_WIDTH, FILES_USEPCT_WIDTH,
    GIB, INFO_BLOCK_HEIGHT, NET_MAC_WIDTH, NET_RX_TX_WIDTH, NET_STATE_WIDTH, PROC_HEADERS,
    PROC_NUM_WIDTH, PROC_PID_WIDTH, SINGLE_LINE_HEIGHT, SPARK_CPU_COLOR, SPARK_CPU_TITLE,
    SPARK_DISK_READ_COLOR, SPARK_DISK_READ_TITLE, SPARK_DISK_WRITE_COLOR, SPARK_DISK_WRITE_TITLE,
...
fn render_dash_gauges(frame: &mut Frame, area: Rect, samples: &Samples) {
    ...
    let (swap_pct, swap_label) = if samples.swap_total > 0 {
        ...
        let used_gb = samples.swap_used as f64 / GIB as f64;
        let total_gb = samples.swap_total as f64 / GIB as f64;
        (
            swap_pct_val as u16,
