...
pub(crate) const MAX_HINTS: usize = 4;

pub(crate) const SPARKLINE_HEIGHT: u16 = 3;

pub(crate) const SPARK_CPU_TITLE: &str = " CPU ";
pub(crate) const SPARK_CPU_COLOR: Color = Color::Green;
pub(crate) const SPARK_MEM_TITLE: &str = " Memory ";
pub(crate) const SPARK_MEM_COLOR: Color = Color::Cyan;
pub(crate) const SPARK_NET_RX_TITLE: &str = " RX ";
pub(crate) const SPARK_NET_RX_COLOR: Color = Color::Green;
pub(crate) const SPARK_NET_TX_TITLE: &str = " TX ";
pub(crate) const SPARK_NET_TX_COLOR: Color = Color::Yellow;
pub(crate) const SPARK_DISK_READ_TITLE: &str = " Read ";
pub(crate) const SPARK_DISK_READ_COLOR: Color = Color::Cyan;
pub(crate) const SPARK_DISK_WRITE_TITLE: &str = " Write ";
pub(crate) const SPARK_DISK_WRITE_COLOR: Color = Color::Yellow;
pub(crate) const SPARK_USAGE_TITLE: &str = " Usage ";
pub(crate) const SPARK_USAGE_COLOR: Color = Color::Magenta;
pub(crate) const SPARK_MEM_HISTORY_TITLE: &str = " History ";
pub(crate) const SPARK_MEM_HISTORY_COLOR: Color = Color::LightBlue;
pub(crate) const SPARK_SWAP_TITLE: &str = " Swap ";
pub(crate) const SPARK_SWAP_COLOR: Color = Color::Yellow;
pub(crate) const SPARK_TEMP_TITLE: &str = " History ";
pub(crate) const SPARK_TEMP_COLOR: Color = Color::Red;

pub(crate) const STYLE_GREEN: Style = Style::new().fg(Color::Green);
pub(crate) const STYLE_CYAN: Style = Style::new().fg(Color::Cyan);
pub(crate) const STYLE_YELLOW: Style = Style::new().fg(Color::Yellow);
pub(crate) const STYLE_MAGENTA: Style = Style::new().fg(Color::Magenta);
pub(crate) const STYLE_DARK_GRAY: Style = Style::new().fg(Color::DarkGray);
pub(crate) const STYLE_SELECTED: Style = Style::new().bg(Color::DarkGray);
pub(crate) const STYLE_RED: Style = Style::new().fg(Color::Red);
pub(crate) const STYLE_GRAY: Style = Style::new().fg(Color::Gray);
pub(crate) const STYLE_BLUE: Style = Style::new().fg(Color::Blue);
pub(crate) const STYLE_BOLD: Style = Style::new().bold();

// Layout constants
pub(crate) const DASH_GAUGE_HEIGHT: u16 = 3;
pub(crate) const SEARCH_BAR_HEIGHT: u16 = 3;
pub(crate) const INFO_BLOCK_HEIGHT: u16 = 8;
pub(crate) const SINGLE_LINE_HEIGHT: u16 = 1;
pub(crate) const STATUS_HINTS_MIN_WIDTH: u16 = 20;

// Dash gauge widths
pub(crate) const DASH_CPU_GAUGE_WIDTH: u16 = 34;
pub(crate) const DASH_MEM_SWAP_GAUGE_WIDTH: u16 = 33;

// Table column widths
pub(crate) const TEMP_COL_WIDTH: u16 = 9;
pub(crate) const FILES_DEVICE_WIDTH: u16 = 14;
pub(crate) const FILES_FS_WIDTH: u16 = 6;
pub(crate) const FILES_SIZE_WIDTH: u16 = 9;
pub(crate) const FILES_USEPCT_WIDTH: u16 = 6;
pub(crate) const FILES_KIND_WIDTH: u16 = 7;
pub(crate) const DISK_IO_RW_WIDTH: u16 = 12;
pub(crate) const NET_RX_TX_WIDTH: u16 = 12;
pub(crate) const NET_STATE_WIDTH: u16 = 8;
pub(crate) const NET_MAC_WIDTH: u16 = 17;
pub(crate) const PROC_PID_WIDTH: u16 = 7;
pub(crate) const PROC_NUM_WIDTH: u16 = 9;

pub(crate) const HINT_SEP: &str = " │ ";

pub(crate) const PROC_HEADERS: &[(&str, ProcSortField)] = &[
...
pub(crate) fn format_memory(gib: f64, pct: f64) -> String {
...
pub(crate) fn format_bytes(bytes: u64, binary: bool) -> String {
    if binary {
        ...
        let divisor: u64 = 1024;
        let mut val = bytes as f64;
        let mut unit_idx = 0;
        while val >= divisor as f64 && unit_idx < units.len() - 1 {
            val /= divisor as f64;
            unit_idx += 1;
        }
...
pub(crate) fn format_temp(temp: Option<f32>) -> String {
    match temp.filter(|t| t.is_finite()) {
        Some(t) => format!("{t:>7.1}°C"),
        None => "      N/A".to_owned(),
    }
}
...
pub(crate) fn format_memory_label(bytes: u64) -> String {
    let gib_threshold = 1 << 30;
    if bytes >= gib_threshold {
        let gib = bytes as f64 / gib_threshold as f64;
        format!("{gib:.1}GiB")
    } else {
...
pub(crate) fn render_sidebar(frame: &mut Frame, area: Rect, app: &App) {
...
pub(crate) fn render_search_bar(frame: &mut Frame, area: Rect, query: &str, focused: bool) -> Rect {
...
pub(crate) fn render_info_block(frame: &mut Frame, area: Rect, items: &[(&str, Cow<'_, str>)]) {
...
pub(crate) fn render_horizontal_tabs(frame: &mut Frame, area: Rect, app: &App) {
...
pub(crate) fn render_status_bar(frame: &mut Frame, status_area: Rect, app: &App) {
...
pub(crate) fn render_overlays(frame: &mut Frame, tab_area: Rect, app: &mut App) {
